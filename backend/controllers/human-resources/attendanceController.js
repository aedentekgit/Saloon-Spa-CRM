...
const getAttendance = async (req, res) => {
  try {
    ...
    if (req.user.role === 'Employee' || req.user.role === 'Client' || (req.authSource === 'Employee' && req.user.role !== 'Manager' && req.user.role !== 'Admin')) {
...
const markAttendance = async (req, res) => {
  ...
  try {
    ...
    const canManageBranchStaff = req.user.role === 'Admin' || req.user.role === 'Manager';
