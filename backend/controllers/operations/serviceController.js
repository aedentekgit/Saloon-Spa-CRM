...
const buildBranchEntry = async (req, targetBranch) => ({
  ...
  referralCommissionType: req.body.referralCommissionType || 'Percentage',
  referralCommissionValue: req.body.referralCommissionValue !== undefined ? Number(req.body.referralCommissionValue) : 0,
...
const updateService = async (req, res) => {
  try {
    ...
    for (const branchId of branchTargets) {
      ...
      entry.referralCommissionType = req.body.referralCommissionType || entry.referralCommissionType || 'Percentage';
      entry.referralCommissionValue = req.body.referralCommissionValue !== undefined ? Number(req.body.referralCommissionValue) : (entry.referralCommissionValue || 0);
    ...
    service.referralCommissionType = undefined;
    service.referralCommissionValue = undefined;
