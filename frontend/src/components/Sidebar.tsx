...
const Sidebar = ({
  ...
  return (
    <aside className={`bg-zen-brown lavender-gradient text-zen-cream h-full transition-all duration-300 ease-in-out flex flex-col shadow-2xl z-20 rounded-[2.5rem] relative overflow-hidden ${isCollapsed ? 'lg:w-20 w-64 md:w-64' : 'w-64'}`}>
