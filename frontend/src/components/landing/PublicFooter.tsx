...
const PublicFooter = () => {
  ...
  return (
    <footer className="bg-[#050506] text-white pt-16 sm:pt-24 md:pt-32 pb-8 sm:pb-14 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-24 mb-14 lg:mb-28">

          {/* Brand Vision */}
          <div className="md:col-span-2 lg:col-span-5 space-y-7 sm:space-y-10 md:space-y-12">
             <div className="space-y-6 sm:space-y-8">
                <NavLink to="/" className="inline-flex items-center gap-3 sm:gap-4 group">
                   ...
                   <span className="font-accent text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-white group-hover:text-zen-sand transition-colors duration-500 break-words">{siteName}</span>
                </NavLink>
                <p className="text-sm sm:text-lg md:text-xl text-white/40 font-light leading-relaxed max-w-sm md:max-w-md">
          ...
          <div className="md:col-span-2 lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-9 sm:gap-12 lg:gap-16">
            {/* Navigation Sections */}
            <div className="space-y-6 sm:space-y-10">
              <h5 className="text-[10px] font-bold text-zen-sand uppercase tracking-[0.32em] sm:tracking-[0.5em]">Explore</h5>
            ...
            <div className="space-y-6 sm:space-y-10">
              <h5 className="text-[10px] font-bold text-zen-sand uppercase tracking-[0.32em] sm:tracking-[0.5em]">Sanctuary</h5>
              <div className="space-y-7 sm:space-y-10">
                ...
                <div className="space-y-3">
                   ...
                   <p className="text-[13px] text-white/50 hover:text-zen-sand transition-colors block">
            ...
            <div className="space-y-6 sm:space-y-10">
              <h5 className="text-[10px] font-bold text-zen-sand uppercase tracking-[0.32em] sm:tracking-[0.5em]">Elite Circle</h5>
              <div className="relative group overflow-hidden rounded-[1.5rem] sm:rounded-[2.5rem] bg-white/[0.03] p-6 sm:p-8 border border-white/5 transition-all hover:bg-white/[0.05] hover:border-zen-sand/30">
                 ...
                 <Link 
                   to="/contact" 
                   className="flex items-center justify-between gap-4 text-[10px] sm:text-[11px] font-black uppercase tracking-[0.18em] sm:tracking-[0.3em] text-white group-hover:text-zen-sand transition-colors relative z-10"
                 >
                    Become a Member
        ...
        {/* Designer Bottom Bar */}
        <div className="pt-8 sm:pt-16 md:pt-20 border-t border-white/5 max-w-[1400px] mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 md:gap-12">
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-3 gap-y-3 sm:gap-x-6 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider sm:tracking-[0.35em] text-white/20 w-full lg:w-auto shrink-0">
               <span className="hover:text-white/40 transition-colors whitespace-nowrap">&copy; 2026 {siteName} Sanctuary</span>
               <span className="text-white/10">•</span>
               <button className="hover:text-white transition-colors relative group whitespace-nowrap">
                 Privacy Policy
            ...
            <div className="hidden lg:flex items-center gap-6 xl:gap-12">
               <div className="h-px w-12 xl:w-24 bg-gradient-to-r from-transparent to-white/5" />
               <div className="font-accent text-lg xl:text-2xl text-white/30 hover:text-white/50 transition-all duration-500 whitespace-nowrap">
                  The Art of <span className="ml-2 font-serif italic text-transparent bg-clip-text bg-gradient-to-r from-zen-sand via-white to-zen-sand font-bold">Profound Balance</span>
               </div>
               <div className="h-px w-12 xl:w-24 bg-gradient-to-l from-transparent to-white/5" />
            </div>
          </div>
        </div>
      </div>
