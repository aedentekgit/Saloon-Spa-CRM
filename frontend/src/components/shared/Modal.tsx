        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-2 sm:p-6 lg:p-10">
          ...
          >
            ...
            {header ? (
              ...
              <div className="flex items-center justify-between px-5 sm:px-8 lg:px-16 py-5 sm:py-8 lg:py-10 border-b border-zen-brown/10 shrink-0 bg-white/40 backdrop-blur-3xl relative z-50">
            ...
            <div className={`flex-1 overflow-y-auto custom-scrollbar relative z-10 ${header || !hideHeader ? 'py-6 sm:py-10 lg:py-16' : 'pt-6 sm:pt-10 lg:pt-16 pb-8 sm:pb-12 lg:pb-20'} px-5 sm:px-8 lg:px-16`}>
              {children}
            </div>

            {footer && (
              <div className="px-5 sm:px-8 lg:px-16 py-5 sm:py-8 lg:py-12 border-t border-zen-brown/10 bg-white/40 backdrop-blur-3xl shrink-0 relative z-50">
                {footer}
              </div>
            )}
