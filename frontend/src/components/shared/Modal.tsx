        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-1.5 sm:p-6 lg:p-10">
          ...
          >
            ...
            {header ? (
              ...
              <div className="flex items-center gap-3 sm:gap-5 px-4 sm:px-8 lg:px-14 py-3 sm:py-6 lg:py-7 border-b border-zen-brown/10 shrink-0 bg-white relative z-50">
                <div className="flex flex-1 items-center gap-3 sm:gap-6 min-w-0 pr-2 sm:pr-4">
                   <div className="w-11 h-11 sm:w-16 sm:h-16 shrink-0 bg-zen-sand/10 rounded-[0.9rem] sm:rounded-[1rem] text-zen-sand flex items-center justify-center shadow-inner border border-zen-sand/5">
                      <HeaderIcon size={22} strokeWidth={1} />
                   </div>
                   <div className="min-w-0 flex-1">
                      <h3 title={typeof title === 'string' ? title : undefined} className="max-w-full text-base sm:text-2xl font-serif font-bold text-zen-brown tracking-tighter truncate leading-tight">{title}</h3>
                      {subtitle && (
                ...
                <button
                   onClick={onClose}
                   className="w-10 h-10 sm:w-12 sm:h-12 shrink-0 flex items-center justify-center bg-white/80 hover:bg-white rounded-full transition-all duration-700 text-zen-brown/35 hover:text-zen-brown group border border-zen-brown/10 shadow-sm"
