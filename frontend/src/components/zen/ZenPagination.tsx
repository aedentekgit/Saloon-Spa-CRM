...
export const ZenPagination: React.FC<ZenPaginationProps> = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 sm:px-10 py-6 border-t border-zen-brown/15 bg-white/50 backdrop-blur-sm rounded-b-[2rem] sm:rounded-b-[3.5rem]">
