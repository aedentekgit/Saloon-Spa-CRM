...
export const ZenPagination: React.FC<ZenPaginationProps> = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 sm:px-10 py-5 border-t border-zen-brown/10 bg-white/80 backdrop-blur-sm">
