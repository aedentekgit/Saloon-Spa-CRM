...
export const getEffectivePermissions = (
  ...
  let roleDefaults = DEFAULT_ROLE_PERMISSIONS[role as UserRole] || [];

  // Fallback default permissions for custom staff roles
  if (roleDefaults.length === 0 && role && role !== 'Client') {
    roleDefaults = DEFAULT_ROLE_PERMISSIONS['Employee'];
  }
