                  ...
                  <div className="aspect-[16/9] sm:aspect-[4/3] relative overflow-hidden bg-white">
                    ...
                    <div className="absolute top-4 right-4 sm:top-6 sm:right-6 flex flex-col items-end gap-2">
                      <div className={`px-3 py-1 sm:px-5 sm:py-2 backdrop-blur-3xl rounded-full text-[9px] sm:text-[10px] font-bold tracking-widest flex items-center gap-2 shadow-lg border border-white/20 ${
                        item.stock <= item.lowStock ? 'bg-red-400 text-white' : 'bg-white/80 text-zen-brown'
                      }`}>
                        {item.stock <= item.lowStock ? <AlertTriangle size={10} className="sm:w-3 sm:h-3" /> : <Box size={10} className="sm:w-3 sm:h-3" />}
            ...
            <table className="w-full text-center border-collapse min-w-[1000px]">
               <thead>
                  <tr className="bg-zen-brown border-b border-zen-brown/15">
                     <th className="px-8 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-center w-24">S No</th>
                     <th className="px-8 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-center w-32">Image</th>
                     <th className="px-10 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-left">Item Name</th>
                     <th className="px-8 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-center">Category</th>
                     <th className="px-8 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-center">Branch</th>
                     <th className="px-8 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-center">Stock</th>
                     <th className="px-8 py-6 text-[10px] font-bold text-zen-brown/40 uppercase tracking-widest text-right">Actions</th>
                  </tr>
               </thead>
                        ...
                        <tr key={item._id} className="group hover:bg-zen-cream/5 transition-all duration-500">
                           ...
                           <td className="px-8 py-5">
                              <div className="flex justify-center">
                                 <div className="w-14 h-10 rounded-2xl bg-zen-cream overflow-hidden border-2 border-white shadow-xl group-hover:scale-110 transition-transform duration-500 flex items-center justify-center">
                                    {item.image ? (
                           ...
                           <td className="px-10 py-5">
                              <div className="flex flex-col items-start text-left">
                                 <p className="font-serif text-lg text-zen-brown font-black tracking-tight leading-tight">{item.name}</p>
                                 <p className="text-[9px] font-black text-zen-brown/20 uppercase tracking-widest mt-0.5">{item.vendor || 'N/A'}</p>
                              </div>
                           </td>
                           <td className="px-8 py-5 text-center">
