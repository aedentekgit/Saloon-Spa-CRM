        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center">
            ...
            >
              ...
              <div className="bg-white/70 backdrop-blur-3xl rounded-[4rem] p-10 lg:p-16 border border-white shadow-[0_50px_100px_-20px_rgba(83,67,55,0.1)] relative overflow-hidden">
      ...
      <section className="px-6 lg:px-24 pb-32">
        <div className="max-w-7xl mx-auto rounded-[5rem] overflow-hidden relative group h-[700px] border border-white/50">
          ...
          <div className="absolute inset-x-0 bottom-24 flex justify-center px-6">
            <div className="p-10 lg:p-14 bg-white/80 backdrop-blur-3xl rounded-[3rem] border border-white shadow-[0_40px_80px_-20px_rgba(83,67,55,0.15)] flex flex-col md:flex-row items-center gap-12 group-hover:-translate-y-4 transition-transform duration-700">
               <div className="space-y-2">
