      ...
      <section className="py-24 md:py-32 px-4 md:px-6 lg:px-24 bg-white/50">
        <div className="max-w-7xl mx-auto space-y-16">
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              ...
              <Link to="/landing-services" className="group flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.3em] text-zen-primary">
                Explore All Rituals
                <div className="w-12 h-12 rounded-full border border-zen-primary/10 flex items-center justify-center group-hover:bg-zen-primary group-hover:text-white transition-all">
                   <ArrowRight size={18} />
                </div>
              </Link>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              {signatureTreatments.map((item, i) => (
                <div key={i} className="group cursor-pointer">
                  ...
                  <p className="text-sm text-zen-primary/50 leading-relaxed">{item.desc}</p>
                </div>
              ))}
           </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              <div key={i} className="group p-8 md:p-10 bg-white border border-zen-primary/5 rounded-[1.5rem] hover:shadow-sm transition-all duration-500 hover:-translate-y-2">
                <div className="w-16 h-16 bg-zen-primary/5 rounded-2xl flex items-center justify-center text-zen-brown mb-8 group-hover:bg-zen-primary group-hover:text-white transition-all duration-500">
                  <pill.icon size={32} />
                </div>
                <h3 className="text-2xl font-serif font-bold mb-4">{pill.title}</h3>
                <p className="text-sm text-zen-primary/60 leading-relaxed font-sans">{pill.desc}</p>
              </div>
            ))}
          </div>
        </div>
           ...
           <div className="space-y-10">
              ...
              <div className="flex gap-12 pt-4">
                 <div>
                    ...
                    <div className="text-[10px] uppercase tracking-widest text-zen-sand">Organic Source</div>
                 </div>
                 <div>
                    <div className="text-4xl font-serif font-bold mb-1">24/7</div>
                    <div className="text-[10px] uppercase tracking-widest text-zen-sand">Concierge Support</div>
                 </div>
              </div>
           </div>
