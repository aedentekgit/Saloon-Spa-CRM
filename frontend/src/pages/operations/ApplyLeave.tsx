            ...
            <AnimatePresence mode="wait">
              ...
              {activeStage === 2 && (
                ...
                >
                  ...
                  <div className="pt-8 flex justify-between items-center">
                    <button onClick={() => setActiveStage(1)} className="text-[10px] font-black uppercase tracking-[0.35em] text-zen-brown/30 hover:text-zen-brown transition-all">Refine Identity</button>
                    <ZenButton
              ...
              {activeStage === 3 && (
                ...
                >
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 opacity-50 select-none">
                        {[
                          ...
                          <div key={i} className="bg-white border border-zen-brown/10 px-4 py-4 rounded-2xl flex items-center gap-3">
                            <rit.i size={14} className="text-zen-brown" />
                            <span className="text-[9px] font-black uppercase tracking-widest text-zen-brown">{rit.l}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="pt-8 flex justify-between items-center">
                    <button onClick={() => setActiveStage(2)} className="text-[10px] font-black uppercase tracking-[0.35em] text-zen-brown/30 hover:text-zen-brown transition-all italic">Refine Temporal Sync</button>
                    <ZenButton
