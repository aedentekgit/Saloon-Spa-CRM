...
const Attendance = () => {
  ...
  return (
    <ZenPageLayout
      ...
      hideAddButton
    >
      <div style={{ '--zen-primary': primaryColor } as React.CSSProperties} className="space-y-10 pb-20">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-end">
            <div className="flex-1 w-full flex flex-col gap-3">
               ...
               <div className="relative group">
                  ...
                  <input
                    type="text"
                    placeholder="Search specialists by name, shift or date..."
                    value={searchTerm}
             ...
             <div className="flex flex-wrap lg:flex-nowrap gap-4 w-full lg:w-auto items-end">
               ...
               {isAdminOrManager && (
                <div className="flex flex-col gap-3 w-full lg:w-auto">
                    ...
                    <ZenButton onClick={() => setIsManualModalOpen(true)} variant="primary" className="w-full sm:w-auto px-8 h-[48px] shadow-sm flex items-center justify-center gap-3">
                       <Sparkles size={16} />
                       <span className="uppercase tracking-[0.2em] text-[10px] font-black">Manual Entry</span>
                    </ZenButton>
                 </div>
               )}
            </div>
        ...
        {loading ? (
          ...
          <div className="w-full bg-white rounded-xl border border-gray-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden flex flex-col min-h-[600px] mx-4 lg:mx-2">
