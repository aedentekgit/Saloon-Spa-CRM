  ...
  return (
    ...
    >
      <div className="space-y-10 pb-20">
        ...
        {/* Global Filter Bar */}
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-2xl border border-zen-brown/15 shadow-sm mx-4 lg:mx-2">
          <div className="flex flex-col xl:flex-row xl:items-end gap-5 xl:gap-8">
            <div className="flex-1 w-full flex flex-col gap-2.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-[54px] pl-[52px] pr-6 bg-zen-cream/30 border border-zen-brown/10 rounded-xl focus:bg-white focus:ring-4 focus:ring-zen-sand/5 focus:border-zen-sand/20 outline-none transition-all duration-500 text-sm font-medium shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="flex flex-wrap xl:flex-nowrap gap-4 w-full xl:w-auto items-end">
              <div className="flex flex-col gap-2.5 w-full xl:w-auto">
                ...
                <div className="flex items-center h-[54px] bg-zen-cream/30 rounded-xl border border-zen-brown/10 shadow-sm shrink-0">
                  <ZenMonthPicker
                    value={selectedMonth}
              ...
              <div className="flex flex-col gap-2.5 w-full xl:w-auto">
                ...
                <ZenButton onClick={handleExport} variant="primary" className="w-full xl:w-auto px-8 h-[54px] shadow-sm flex items-center justify-center gap-2 group rounded-xl">
