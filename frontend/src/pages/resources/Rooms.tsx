  ...
  return (
    ...
    >
                  ...
                  {filteredRooms.map((room, index) => {
                    ...
                    <tr key={room._id}>
                      ...
                      <td>
                       ...
                       <td>
                         <span className="zen-table-meta">{room.branch?.name || 'Main Registry'}</span>
                       </td>
                       <td>
      ...
      <Modal 
        ...
        subtitle="Space Registry Allocation"
        footer={
        ...
        <form id="roomForm" onSubmit={handleSubmit} className="space-y-12">
           <div className="flex items-center gap-8 sm:gap-12">
              ...
              <div className="flex-1">
                 <ZenInput label="Sanctuary Designation" placeholder="E.g. Sapphire Suite" value={formData.name} onChange={(e: any) => setFormData({...formData, name: e.target.value})} className="font-serif text-2xl sm:text-5xl border-none p-0 h-auto font-bold tracking-tighter" />
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 sm:gap-x-16 gap-y-10 sm:gap-y-14 animate-in fade-in duration-500">
              ...
              <div className="md:col-span-1">
                 <div className="p-10 bg-zen-sand/5 rounded-[3rem] border border-zen-sand/10 shadow-inner flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-[11px] text-zen-brown/40 font-bold uppercase tracking-widest leading-relaxed">
                       Sanctuary status and visual identity are unified within the network.
                    </p>
                 </div>
              </div>
           </div>
